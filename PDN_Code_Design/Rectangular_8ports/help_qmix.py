...
def copy_and_rename_files(episode, count):
    ...
    source_folder = user_name + r"\PI_PG_WI2324\Rectangular_8ports\Design1.emc\PI-1/Power_GND"  # 替换为源文件夹的路径
    ...
    folder_path= user_name + r"PI_PG_WI2324\Rectangular_8ports\result_Qmix"# 替换为目标文件夹的路径
...
def load_batch_file(destination_file):
    user_name = r"C:\Users\emago"
    if os.path.exists(user_name + r'\PI_PG_WI2324\Rectangular_8ports\Design1.emc\Design1.rlk'):
        os.remove(user_name + r'\PI_PG_WI2324\Rectangular_8ports\Design1.rlk')
    ...
    ERFPath = user_name + r"\PI_PG_WI2324\Rectangular_8ports\Qmix\Design1.emc\Design1.erf"
